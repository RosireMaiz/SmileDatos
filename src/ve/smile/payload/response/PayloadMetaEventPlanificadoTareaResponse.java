...
public class PayloadMetaEventPlanificadoTareaResponse implements IPayloadResponse<MetaEventPlanificadoTarea> {

	private HashMap<String, Object> informacion;

	private List<MetaEventPlanificadoTarea> objetos;

	public PayloadMetaEventPlanificadoTareaResponse() {
		super();
