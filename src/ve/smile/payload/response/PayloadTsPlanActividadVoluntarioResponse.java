...
public class PayloadTsPlanActividadVoluntarioResponse implements IPayloadResponse<TsPlanActividadVoluntario> {

	private HashMap<String, Object> informacion;

	private List<TsPlanActividadVoluntario> objetos;

	public PayloadTsPlanActividadVoluntarioResponse() {
		super();
