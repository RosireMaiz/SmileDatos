...
public class PayloadTsPlanActividadTrabajadorResponse implements IPayloadResponse<TsPlanActividadTrabajador> {

	private HashMap<String, Object> informacion;

	private List<TsPlanActividadTrabajador> objetos;

	public PayloadTsPlanActividadTrabajadorResponse() {
		super();
