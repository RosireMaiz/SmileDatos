...
public class PayloadClasificadorCapacitacionResponse implements IPayloadResponse<ClasificadorCapacitacion> {

	private HashMap<String, Object> informacion;

	private List<ClasificadorCapacitacion> objetos;

	public PayloadClasificadorCapacitacionResponse() {
		super();
