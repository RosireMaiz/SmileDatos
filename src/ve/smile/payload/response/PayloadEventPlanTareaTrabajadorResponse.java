...
public class PayloadEventPlanTareaTrabajadorResponse implements IPayloadResponse<EventPlanTareaTrabajador> {

	private HashMap<String, Object> informacion;

	private List<EventPlanTareaTrabajador> objetos;

	public PayloadEventPlanTareaTrabajadorResponse() {
		super();
